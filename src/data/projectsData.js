...
const projectsData = [
  {
    ...
    imagesData: slides,
    paragraphs: [
      <>A landing page was developed to introduce Moenia, an app dedicated to exploring Europe's archaeological treasures. The page was designed in <b style={{ color: "#da4167" }}>React</b> to captivate users, inform them about Moenia's features, and drive app downloads.</>,
  ...
  },
  {
    ...
    paragraphs: [
      <>This project showcases the development of a robust and user-friendly admin dashboard utilizing <b style={{ color: "#da4167" }}>React</b> and <b style={{ color: "#da4167" }}>SCSS</b> and it was designed specifically for an eLearning platform, English Seed. By leveraging the power of React's component-based architecture, the dashboard seamlessly integrates interactive elements, data visualizations, and a user-friendly interface and the implementation of SCSS ensures maintainable and scalable styling.</>,
      <>This frontend project incorporates React Query for data handling and testing. Testing with <b style={{ color: "#da4167" }}>React Query</b> was conducted on key data-driven pages, including Users, Orders, and Products management sections. This project not only addresses a crucial need in education but also serves as a valuable template for developing other data-driven admin dashboards, demonstrating adaptability and scalability beyond this specific use case.</>
    ],
  },
  {
    id: 5,
  ...
  },
  {
    ...
    paragraphs: [
      ...
      <>
      <br />
        Camperizzati is a web application designed to connect individuals looking to customize their vans into campers with skilled artisans across Italy who can realize their projects.
      </>,
      <>The app's frontend was built with <b style={{ color: "#da4167" }}>Angular</b>. It uses Angular's components and routing to create an organized and easy-to-navigate interface. Data is managed through Angular services and state management utilizing <b style={{ color: "#da4167" }}>RxJS observables</b> for asynchronous operations. While the current setup uses a local <b style={{ color: "#da4167" }}>JSON Server</b> for development, its service-oriented design allows for easy integration with a full-fledged backend. The app's style is achieved with <b style={{ color: "#da4167" }}>plain CSS</b> and it is designed to be fully responsive, adapting its layout and presentation across various devices to provide an optimal user experience.</>
    ],
  },
];
