...
const projectsData = [
  {
    ...
    paragraphs: [
      ...
      <>
        ...
        <b style={{ color: pink }}>Angular</b>. It uses Angular's
  ...
  },
  {
    ...
    paragraphs: [
      ...
      The app's was built with{" "}
        <b style={{ color: pink }}>React Native</b> and {" "}
        <b style={{ color: pink }}>Expo</b> framework.
      </>,
    ],
  },
  {
    ...
    paragraphs: [
      <>
        ...
        <b style={{ color: pink }}>React</b>, the app uses geolocation and
        communicates with a trusted, free, and official weather API via a
        dedicated <b style={{ color: pink }}>Node.js</b> backend to keep
      ...
      <>
        ...
        <b style={{ color: pink }}>Styled Components</b> were used for
        styling.
      </>,
    ],
  },
    ...
    paragraphs: [
      <>
        ...
        admin dashboard utilizing <b style={{ color: pink }}>React</b> and{" "}
        <b style={{ color: pink }}>SCSS</b> and it was designed
      ...
      <>
        ...
        testing. Testing with <b style={{ color: pink }}>React Query</b>{" "}
  ...
  },
  {
    ...
    paragraphs: [
      <>
        ...
        <b style={{ color: pink }}>React</b> for the frontend,{" "}
        <b style={{ color: pink }}>Node.js</b> for the backend,{" "}
        <b style={{ color: pink }}>MongoDB</b> as the database and styling
        with <b style={{ color: pink }}>Styled Components</b>.
      </>,
      <>
        Key features include secure user authentication via{" "}
        <b style={{ color: pink }}>JWT</b>, global state management with{" "}
        <b style={{ color: pink }}>Redux</b>, and payment integration with{" "}
        <b style={{ color: pink }}>Stripe</b>. The frontend is built using
  ...
  },
  {
    ...
    paragraphs: [
      <>
      'Unwind Stays is a web application designed to facilitate the discovery and rental of holiday homes in natural European settings. Built with the latest version of <b style={{ color: pink }}>Angular</b>, it offers a seamless user experience.
      <br />
  ...
  },
  {
    ...
    paragraphs: [
      <>
        ...
        <b style={{ color: pink }}>React</b> to captivate users, inform
